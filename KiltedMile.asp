...
<table width="772" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <!-- InstanceBeginEditable name="text" --><!--#include file="FeaturedSponsors.asp" -->
    <h1><b></b>Kilted Mile</h1>
    <p><img src="agile_carousel_slides/slide04.jpg" width="464" height="331" alt=""/></p>
    <p>Registration for the Kilted  Mile is free to all and starts at 9 o’clock Sunday at the Heavy Athletics Tent  on the southeast corner of the games field.</p>
    <p>The races start on the games field at 12 o&rsquo;clock sharp.  Participants 13 and over will run one mile, children 7-12 will run ¼ mile,  children 6 and under will run 1/8 mile. Timing is performed using a stopwatch,  top 3 males and females of each race will receive medals. ALL RUNNERS MUST BE  KILTED AT ALL TIMES!</p>
<p>&nbsp;</p>
