...
<script src="engine/js/visuallightbox.js" type="text/javascript"></script>
  ...
  Set objFile = objFSO.GetFile(Server.MapPath("/images/LNG2016/P4151179-Edit.tif.jpg"))
...
<%
  For Each objFileItem In objFolderContents %>
   ...
   <a class="vlightbox1" href="images/LNG2016/<%=objFileItem.Name%>" title="<%=objFileItem.Name%>" style="display:inline-block; vertical-align:top; height:100px; overflow:hidden; text-align:center; max-width:100px; width:20%; margin:2%; border:4px solid #fff; box-shadow:0px 0px 6px 3px #ccc;"><img src="images/LNG2016_thumbs/<%=objFileItem.Name%>" alt="<%=objFileItem.Name%>" style="max-width: 150px; min-height:100px; vertical-align:middle; display:block;" /></a>
...
%>
  ...
  <script type="text/javascript">
  $(document).ready(function(){ window.Lightbox = new $().visualLightbox({autoPlay:true,borderSize:16,classNames:'vlightbox1',descSliding:true,enableRightClick:false,enableSlideshow:true,resizeSpeed:7,slideTime:4,startZoom:true}) });
  </script>           
